...
import com.JWT_firstTest.securityCrud.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth.requestMatchers("/auth/welcome", "/auth/addNewUser", "/auth/signIn" ,"/auth/signUp" ).permitAll())
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authenticationProvider.setPasswordEncoder(passwordHashing());
